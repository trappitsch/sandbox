//! This code is based on the teensy4-rs template and tries to implement
//! the defmt usb logger example on that same website. 
//! This implementation is mostly a dependency problem at this point.
